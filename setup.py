...
utaws :  Copyright 2017-2018, Blake Huber
...
setup(
    name='utaws',
    version=utaws.__version__,
    description='Python Utilities for Amazon Web Services',
    long_description=read('DESCRIPTION.rst'),
    url='http://utaws.readthedocs.io',
    author=utaws.__author__,
    author_email=utaws.__email__,
    license='GPL-3.0',
    classifiers=[
    ...
    entry_points={
        'console_scripts': [
            'utaws=utaws.cli:init_cli',
            'utawsconfig=utaws.cli:option_configure'
        ]
    },
    zip_safe=False
)
